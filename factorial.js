...
sum(5); // Output: The factorial of 5 is 120.
sum(-2); // Output: Error: Factorial is not defined for negative numbers.
sum(3.5); // Output: Error: Factorial is not defined for floating-point numbers.
